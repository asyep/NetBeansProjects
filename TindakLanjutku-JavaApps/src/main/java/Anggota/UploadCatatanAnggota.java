...
public class UploadCatatanAnggota extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(UploadCatatanAnggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new UploadCatatanAnggota("admin").setVisible(true);
        });
    }
